...
void ft_run_shell(void) 
{
    ...
    do 
    {
		...
		// {
		// 	printf("%i\n", commands->exit_status);
		// }
            	// e_status.last_exit_status = commands->exit_status;
		// while (another->args[0] >= 'a' && another->args[0] <= 'z' || another->args[0] >= 'A' && another->args[0] <= 'Z')
		// {
		// 	if (another->next == NULL)
        //     	e_status.last_exit_status = commands->exit_status;
		// }
        // if (commands != NULL && another->next == NULL)
        //     e_status.last_exit_status = commands->exit_status;
        // else
        // {
		...
		while (another && another->next && (another->exit_status!=130 && another->exit_status != 131))
			another = another->next;
		e_status.last_exit_status = another->exit_status;
		// if (e_status.last_exit_status != 130 && e_status.last_exit_status != 131)
		// 	e_status.last_exit_status = another->exit_status;
		// execute_external_running = 0;
        free_tokens(tokens);
